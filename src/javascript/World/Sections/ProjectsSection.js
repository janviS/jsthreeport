    ...
    this.list = [
      {
        name: "Condo",
        imageSources: [
          "./models/projects/threejsJourney/condo1.JPG",
          "./models/projects/threejsJourney/condo.png",
          "./models/projects/threejsJourney/condo2.JPG",
          "./models/projects/threejsJourney/condo3.JPG",
        ],
        floorTexture: this.resources.items.projectsThreejsJourneyFloorTexture,
        link: {
          href: "https://www.condobase.xyz/",
          x: -4.8,
          y: -3,
          halfExtents: {
            x: 3.2,
      ...
      },
      {
        name: "AGMI CLUB",
        imageSources: [
          "./models/projects/chartogne/agmi.JPG",
          "./models/projects/chartogne/agmi2.JPG",
          "./models/projects/chartogne/agmi3.JPG",
          "./models/projects/chartogne/agmi4.JPG",
        ],
        floorTexture: this.resources.items.projectsChartogneFloorTexture,
        link: {
          href: "https://agmi.club/",
          x: -4.8,
          y: -3.3,
          halfExtents: {
            x: 3.2,
      ...
      },
      {
        name: "SVAD",
        imageSources: [
          "./models/projects/svad/svad.JPG",
          "./models/projects/svad/svad1.JPG",
          "./models/projects/svad/svad2.JPG",
          "./models/projects/svad/svad3.JPG",
        ],
      ...
      },
      {
        name: "Axoverse",
        imageSources: [
          "./models/projects/luni/axoverse.JPG",
          "./models/projects/luni/axo1.JPG",
          "./models/projects/luni/axo2.JPG",
          "./models/projects/luni/axo3.JPG",
        ],
        floorTexture: this.resources.items.projectsLuniFloorTexture,
        link: {
          href: "https://axoverse.xyz",
          x: -4.8,
          y: -3,
          halfExtents: {
            x: 3.2,
